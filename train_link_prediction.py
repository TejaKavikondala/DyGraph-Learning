...
def compute_graph_centrality(full_data, centrality_type="degree"):
    """
    Construct a graph from full_data and compute centrality scores.
    :param full_data: Data object containing all interactions.
    :param centrality_type: Type of centrality ('degree' or 'betweenness').
    :return: Dictionary with node IDs as keys and centrality scores as values.
    """
    graph = nx.Graph()
    graph.add_edges_from(zip(full_data.src_node_ids, full_data.dst_node_ids))
...
if __name__ == "__main__":
    ...
    centrality_scores = compute_graph_centrality(full_data, centrality_type="degree")
    ...
    for run in range(args.num_runs):
        ...
        if args.model_name == 'TGAT':
            ...
            dynamic_backbone = DyGFormer(node_raw_features=node_raw_features, edge_raw_features=edge_raw_features, neighbor_sampler=train_neighbor_sampler,
                                         ...
                                         max_input_sequence_length=args.max_input_sequence_length, device=args.device, centrality_scores = centrality_scores )
        else:
